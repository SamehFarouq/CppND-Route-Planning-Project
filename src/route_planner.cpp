...
current_neighbors->g_value=current_node->g_value+current_neighbors->distance(*current_node);

current_neighbors->h_value=RoutePlanner::CalculateHValue(current_neighbors) ;
